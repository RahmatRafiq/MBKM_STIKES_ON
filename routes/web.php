...
Route::middleware('auth')->group(function () {
    ...
    // Route::get('mbkm/admin/role-permissions/{role}/add-Permission', [\App\Http\Controllers\RolePermission\RoleController::class, 'addPermissionToRole'])->name('role.addPermission');
