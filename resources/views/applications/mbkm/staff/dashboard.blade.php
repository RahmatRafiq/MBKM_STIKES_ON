    ...
    <div class="row gx-3">
        ...
        <div class="col-xl-4 col-md-6 col-12">
            <div class="card mb-3 card-custom background-gradient-7">
                ...
                <div class="card-body">
                    <div
                        class="bg-light px-3 py-2 d-flex justify-content-between align-items-center rounded shadow-sm mb-3 text-black">
                    ...
                    <div class="peserta-list mt-3">
                        ...
                        <div
                            class="peserta-item bg-white rounded shadow-sm p-3 mb-2 w-100 d-flex justify-content-between align-items-center">
                            <div>
