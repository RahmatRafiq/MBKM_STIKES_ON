                                            ...
                                            <form action="{{ route('staff.updateRegistrasi', $registration->id) }}"
                                                ...
                                                <select name="status" class="form-control">
                                                    ...
                                                    <option value="accepted"
                                                        @if ($registration->status == 'accepted') selected @endif>
                                                        Diterima
                                                    </option>
                                                    ...
                                                    <option value="rejected"
                                                        @if ($registration->status == 'rejected') selected @endif>
                                                        Ditolak
                                                    </option>
                                                    <option value="rejected_by_user"
                                                        @if ($registration->status == 'rejected_by_user') selected @endif>Ditolak oleh
                                                        Peserta</option>
