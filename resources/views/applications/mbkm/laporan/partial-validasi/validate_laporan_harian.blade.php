                        ...
                        <tr id="laporan-harian-{{ $laporan->id }}">
                            ...
                            <td>
                                ...
                                <button class="btn btn-outline-success validate-btn mb-1" data-id="{{ $laporan->id }}"
                                    data-type="harian" data-action="validasi">
                                    Validasi
                                </button>
                                <button class="btn btn-outline-danger validate-btn mb-1" data-id="{{ $laporan->id }}"
                                    data-type="harian" data-action="revisi" data-toggle="modal"
                                    data-target="#feedbackModalHarian-{{ $laporan->id }}">
                                    Revisi
                                </button>
                                @endif
                            </td>
...
@foreach ($laporanHarian as $laporan)
<div class="modal fade" id="feedbackModalHarian-{{ $laporan->id }}" tabindex="-1" role="dialog"
    aria-labelledby="feedbackModalLabelHarian-{{ $laporan->id }}" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="feedbackModalLabelHarian-{{ $laporan->id }}">Masukkan Feedback untuk Revisi
                </h5>
