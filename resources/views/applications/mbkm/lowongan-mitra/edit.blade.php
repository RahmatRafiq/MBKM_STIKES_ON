                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                value="{{ old('name', $lowongan->name) }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="quota" name="quota"
                                value="{{ old('quota', $lowongan->quota) }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="location" name="location"
                                value="{{ old('location', $lowongan->location) }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="gpa" name="gpa"
                                value="{{ old('gpa', $lowongan->gpa) }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="experience_required" name="experience_required"
                                value="{{ old('experience_required', $lowongan->experience_required) }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="start_date" name="start_date"
                                value="{{ old('start_date', $lowongan->start_date) }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="end_date" name="end_date"
                                value="{{ old('end_date', $lowongan->end_date) }}" required>
                        </div>
                    </div>
                </div>
                <div class="row">
