        ...
        <div class="card-body">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('batch-mbkms.update', $batch->id) }}">
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label">Name</label>
                        <input type="text" class="form-control" id="name" name="name" required placeholder="Name" value="{{ old('name', $batch->name) }}" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="semester_start" class="form-label">Semester Start</label>
                        <input type="date" class="form-control" id="semester_start" name="semester_start" required value="{{ old('semester_start', $batch->semester_start) }}" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="semester_end" class="form-label">Semester End</label>
                        <input type="date" class="form-control" id="semester_end" name="semester_end" required value="{{ old('semester_end', $batch->semester_end) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="checkbox" id="is_active" name="is_active" value="1" {{ $batch->is_active ? 'checked' : '' }} disabled>
                    </div>
                    <button type="submit" class="btn btn-primary">Update Batch MBKM</button>
                </form>
            </div>
